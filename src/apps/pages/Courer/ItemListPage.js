...
import { COLUMNS } from "../../components/tables/column/PendingItemListColumn";
            ...
            <div className="content">
                ...
                <div className="row table_section">
                    <div className="col-md-12">
                        <DataTable COLUMNS={COLUMNS} endpoint={"https://backend.huxhtech.com/api/v1/huxh-deal/availableOrder"} />
                    </div>
                </div>
            </div>
